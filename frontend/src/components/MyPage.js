...
import { FaPencilAlt, FaCamera, FaUserCircle, FaCheck, FaTimes } from "react-icons/fa";
...
function MyPage({ user }) {
  ...
  return (
    <div style={{ padding: "40px", maxWidth: "600px", margin: "0 auto", backgroundColor: "#fff", borderRadius: "20px", boxShadow: "0 10px 15px -3px rgba(0,0,0,0.1)" }}>
      {/* 프로필 섹션 */}
